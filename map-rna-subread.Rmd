...
buildindex(basename="GRCh38",reference="Homo_sapiens.GRCh38.dna.chromosome.22.fa.gz")

align_dat <- align(index="GRCh38",
                   readfile1="1001-Effector_CD4pos_T-S_chr22_filtered_R1.fastq.gz",
                   readfile2 = "1001-Effector_CD4pos_T-S_chr22_filtered_R2.fastq.gz",
...
r1_list <- list.files("/home/data", pattern = "chr22_R1.fastq.gz",
                      full.names = TRUE)
r2_list <- list.files("/home/data", pattern = "chr22_R2.fastq.gz",
                      full.names = TRUE)
bam_list <- basename(r1_list) %>%
    str_replace("_chr22_R1.fastq.gz", ".bam")
