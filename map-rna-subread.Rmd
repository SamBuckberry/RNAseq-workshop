...
See if you can transform these data to assess percentage of aligned fragments. 
```{r}
align_dat <- do.call(cbind, align_dat)
datatable(align_dat)
```

Create the table of counts for genes and transcripts using the `featureCounts` function from Subread. 
```{r}
